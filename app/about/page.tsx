      ...
      <div className="lg:flex mb-16">
        <div className="prose lg:prose-2xl prose-invert grow">
          ...
          <p>
            ...
            confounded by Max, but stuck with it and really enjoy working with
            it now.
          </p>
          <p>
            Through the years since then, I&apos;ve developed and released a lot
            of different devices. All of them stem from some desire for a
            capability or workflow in{' '}
          ...
          <p>
            In 2024, I retired from full-time work and have been able to devote
            more time and energy into these projects. I was fortunate to be the
            right{' '}
            <Link href="https://steinkamp.us/posts/2021-05-22-computer-history">
              person
            </Link>{' '}
            with the right friends in the right place in the right time and had
            a great <Link href="https://steinkamp.us/resume">career</Link> as an
            ...
            contributed back to the projects they relied on, but that was more
            the exception than the rule. Every Silicon Valley success story is
            built on the backs of countless dedicated project maintainers,
            powered solely by curiosity and the common good.
          </p>
          <p>
            In the spirit of paying good fortune forward, I have taken the
            approach that my plugins will be freely available and developed in
            the open. I enjoy using my time and energy to enrich the lives of
            artists through building tools for them, and feel happy if I can
            contribute to the overall art ecosystem in a positive way.
          </p>
          <p>
