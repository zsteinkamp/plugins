...
export default function KnobblerPage() {
  return (
    <div className="w-full bg-background text-foreground overflow-x-hidden">
      {/* Top nav */}
      <nav className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-6 py-5 sm:px-10">
        <Link
          href="/"
          className="font-heading text-2xl text-highlight hover:text-highlight2 transition-colors"
        >
          ← Zack&apos;s Plugins
        </Link>
        <Link
          href="/m4l-Knobbler4"
          className="font-heading text-lg text-foreground/80 hover:text-highlight transition-colors"
        >
          Plugin page
        </Link>
      </nav>
